...
def get_col_names(file, df_col_info, col_name):
    ...
    return qval_col, log2FC_col, is_ratio_log2FC, target_qval_col, target_log2FC_col


def get_qval_log2FC_func(df_col_info, df_WG, df_tn_qval_log2FC_ALL, dir_name = '.'):
    
    for index, row in df_col_info.iterrows():
    # for file in file_list:
        ...
        # read the data.
        df_tn = pd.read_excel(os.path.join('../../data/SI_datasets', file))
