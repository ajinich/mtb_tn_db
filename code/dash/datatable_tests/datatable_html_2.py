...
#     Thead = html.Thead(
#         [html.Tr([html.Th(col, style={'background-color':"#FF0000"}) for col in df.columns])]
#     )
#     Tbody = html.Tbody(
#         [html.Tr(
...
#     )
#     return html.Table(data=[Thead, Tbody], id=id, className="display")
...
app.layout = html.Div([
    ...
    html.Br(),
    html.Div(
        Table(test_table, id='datatable1'),
        style={'width': '40%'}
    ),
